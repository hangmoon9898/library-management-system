    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <div class="wrapper">
            <input type="text" class="form-control reg-field" name="imageFile" placeholder="books image" value="<?php if(isset($fileName)){echo $fileName;} ?>" readonly style="display: inline-block; width: calc(100% - 127px);">
            ...
            <input type="text" class="form-control reg-field" name="bprice" placeholder="books price" value="<?php if ($a["price"] != " ") {echo $a["price"];} ?>">
